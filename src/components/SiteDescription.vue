	...
	<section class="section">
		...
		<section class="container has-text-centered">
			...
			<section class="content">
				...
				<p>
					This website is maded using this technologies: Vue, Jest, Cypress, Bulma, Buefy and other. A public API is being used to get the data. If you want you can explore the source code on GitHub. In the top menu you will find a link to go to the source code.
				</p>
			</section>
		</section>
